...
interface BudgetTableDbProps {
  tipo: 'materials' | 'machines' | 'production';
  dados: DbBudgetItem[];
  onAdd: () => void;
...
export const BudgetTableDb = ({ tipo, dados, onAdd, onRemove, onUpdate }: BudgetTableDbProps) => {
                  ...
                  >
                    ...
                    <td className="px-4 py-2">
                      <Input
                        ...
                        onChange={e => onUpdate(item.id, 'preco_unit', parseFloat(e.target.value) || 0)}
